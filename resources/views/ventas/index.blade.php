            ...
            <tbody>
                @foreach ($ventas as $venta)
                    <tr>
                        ...
                        <!-- Mostrar todos los productos asociados -->
                        <td>
                        ...
                        <!-- Sumar todas las cantidades de productos en la venta -->
                        <td>
                            @foreach ($venta->productos as $producto)
                        ...
                        <td>
                            ...
                            <!-- Botón de descargar voucher -->
                            <a href="{{ route('ventas.voucher', $venta->id) }}" class="btn btn-info btn-sm rounded-pill">
                                <i class="bi bi-file-earmark-pdf"></i> Descargar Voucher
                            </a>
